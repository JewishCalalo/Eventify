...
const Something = ({ item }) => (
  <View style={[styles.dropdownContainer, { zIndex: item.open ? 5000 : 1 }]}>
    ...
    <DropDownPicker
      ...
      listMode="SCROLLVIEW"  // Ensure the dropdown uses scroll view mode
    />
  </View>
);
...
export default function Settings() {
  ...
  const handleApplyChanges = async () => {
    ...
    Alert.alert("Settings applied.", "", [
      {
        text: "OK",
        onPress: () => navigation.navigate('Profile'),  // Explicitly navigate to the Profile screen
      },
    ]);
  };
    ...
    <KeyboardAvoidingView style={styles.container} behavior={Platform.OS === "ios" ? "padding" : "height"}>
      ...
      const styles = StyleSheet.create({
        ...
        dropdownMenuContainer: {
          ...
          zIndex: 1000,
          elevation: 3,
          maxHeight: 250, // Ensure dropdown menu is scrollable
        },
        dropdownText: {
          color: '#333',
          fontSize: 16,
