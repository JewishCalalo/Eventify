...
import * as ImagePicker from 'expo-image-picker'; // Ensure this is imported correctly
...
export default function ProfileTab() {
  ...
  const pickImage = async () => {
    ...
    let result = await ImagePicker.launchImageLibraryAsync({
      mediaTypes: ImagePicker.MediaTypeOptions.Images, // Use MediaTypeOptions for correct media type
      allowsEditing: true,
      aspect: [4, 3],
      quality: 1,
    });
